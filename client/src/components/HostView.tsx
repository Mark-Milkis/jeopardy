    ...
    <div className="h-full w-full bg-gray-100 flex flex-col font-sans text-gray-900 overflow-hidden relative">
      ...
      <div className="h-20 bg-gray-900 text-white flex items-center px-4 gap-4 overflow-x-auto border-b-4 border-[#FFCC00] shadow-lg shrink-0 scrollbar-hide">
        ...
        <div className="flex gap-2">
          <button onClick={() => setShowSettings(true)} className="p-2 text-gray-400 hover:text-white transition-colors" title="Settings">
          ...
          <Link to="/seasons" className="p-2 text-gray-400 hover:text-white transition-colors" title="Browse Games">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
            </svg>
          </Link>
          <button onClick={() => window.open('/#/board', '_blank')} className="p-2 text-gray-400 hover:text-white transition-colors" title="Open Board in New Window">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
